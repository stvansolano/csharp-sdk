...
/// <summary>
/// Represents an Agent that can interact with MCP servers and AI models.
/// </summary>
public class Agent : IAsyncDisposable
{
    ...
    /// </summary>
    /// <param name="modelId">The ID of the AI model to use.</param>
    /// <param name="mcpServers">Optional list of MCP servers to connect to.</param>
    /// <param name="loggerFactory">Optional logger factory to use for logging.</param>
    public Agent(string modelId, IList<McpServerStdio>? mcpServers = null, ILoggerFactory? loggerFactory = null)
    {
        _modelId = modelId ?? throw new ArgumentNullException(nameof(modelId));
        _mcpServers = mcpServers ?? new List<McpServerStdio>();
    ...
    public async Task<AgentResult> RunAsync(string prompt, ChatOptions? options = null, CancellationToken cancellationToken = default)
    {
        ...
        var response = await aiClient.GetResponseAsync(messages, chatOptions, cancellationToken);
...
public class AgentResult
{
    ...
    /// </summary>
    public List<AITool> ToolCalls { get; set; } = new();
}
